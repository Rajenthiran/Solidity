...
<html lang="en">
<head>
    <title>Code coverage report for marko-v4/taglibs/html/html-comment-tag.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">marko-v4/taglibs/html/</a> html-comment-tag.js
    </h1>
    <div class='clearfix'>
...
module.exports = function render(input, out) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (out.write) {
        out.write('&lt;!--');
