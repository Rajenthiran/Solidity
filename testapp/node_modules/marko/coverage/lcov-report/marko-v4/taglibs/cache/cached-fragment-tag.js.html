...
<html lang="en">
<head>
    <title>Code coverage report for marko-v4/taglibs/cache/cached-fragment-tag.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">marko-v4/taglibs/cache/</a> cached-fragment-tag.js
    </h1>
    <div class='clearfix'>
...
module.exports = {
    render: function (input, out) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!cacheKey) {
...
&nbsp;
        var cache = cacheManager.getCache(input.cacheName || <span class="branch-1 cbranch-no" title="branch not covered" >'marko/cached-fragment')</span>;
&nbsp;
