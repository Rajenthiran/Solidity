...
<html lang="en">
<head>
    <title>Code coverage report for marko-v4/compiler/util/removeComments.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">marko-v4/compiler/util/</a> removeComments.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    tokenizer.forEachToken(str, (token) =&gt; {
        switch(token.name) {
<span class="branch-0 cbranch-no" title="branch not covered" >            case 'singleLineComment':</span>
