...
<html lang="en">
<head>
    <title>Code coverage report for marko-v4/compiler/Parser.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">marko-v4/compiler/</a> Parser.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">88.11% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>163/185</span>
      </div>
      <div class='fl pad1y space-right2'>
...
401
402
403</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1014×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2922×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2922×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2799×</span>
<span class="cline-any cline-yes">2799×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1676×</span>
<span class="cline-any cline-yes">1676×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1676×</span>
<span class="cline-any cline-yes">1676×</span>
...
<span class="cline-any cline-yes">1672×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1669×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1669×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1669×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1269×</span>
<span class="cline-any cline-yes">1269×</span>
<span class="cline-any cline-yes">633×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1665×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1665×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4965×</span>
<span class="cline-any cline-yes">4965×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1676×</span>
<span class="cline-any cline-yes">1276×</span>
<span class="cline-any cline-yes">1276×</span>
<span class="cline-any cline-yes">1276×</span>
<span class="cline-any cline-yes">4×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1272×</span>
<span class="cline-any cline-yes">9×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1663×</span>
<span class="cline-any cline-yes">1663×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1663×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1661×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1676×</span>
...
&nbsp;
                ...
                } else <span class="missing-if-branch" title="else path not taken" >E</span>if (node.callee.name === '$escapeXml') {
...
&nbsp;
        var raw = this.raw;
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!raw) {
...
&nbsp;
                    if (valid) {
                        <span class="missing-if-branch" title="if path not taken" >I</span>if (raw) {
<span class="cstat-no" title="statement not covered" >                            attrValue = parsedExpression;</span>
                        } else {
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (raw) {
&nbsp;
<span class="cstat-no" title="statement not covered" >            node = builder.htmlElement(elDef);</span>
<span class="cstat-no" title="statement not covered" >            node.pos = elDef.pos;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            let taglibLookup = this.context.taglibLookup;</span>
<span class="cstat-no" title="statement not covered" >            let tagDef = taglibLookup.getTag(tagName);</span>
<span class="cstat-no" title="statement not covered" >            node.tagDef = tagDef;</span>
        } else {
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (raw) {
<span class="cstat-no" title="statement not covered" >            if (el.shorthandId) {</span>
<span class="cstat-no" title="statement not covered" >                let parsed = builder.parseExpression(el.shorthandId.value);</span>
<span class="cstat-no" title="statement not covered" >                node.rawShorthandId = parsed.value;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (el.shorthandClassNames) {</span>
<span class="cstat-no" title="statement not covered" >                node.rawShorthandClassNames = el.shorthandClassNames.map((className) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                    let parsed = builder.parseExpression(className.value);</span>
<span class="cstat-no" title="statement not covered" >                    return parsed.value;</span>
                });
            }
        } else {
...
&nbsp;
            if (el.shorthandId) {
                <span class="missing-if-branch" title="if path not taken" >I</span>if (node.hasAttribute('id')) {
<span class="cstat-no" title="statement not covered" >                    context.addError(node, 'A shorthand ID cannot be used in conjunction with the "id" attribute');</span>
                } else {
...
&nbsp;
    handleEndElement(elementName) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.raw !== true) {
...
&nbsp;
    handleDeclaration<span class="fstat-no" title="function not covered" >(value) {</span>
<span class="cstat-no" title="statement not covered" >        this.prevTextNode = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var builder = this.context.builder;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var declarationNode = builder.declaration(builder.literal(value));</span>
<span class="cstat-no" title="statement not covered" >        this.parentNode.appendChild(declarationNode);</span>
    }
&nbsp;
...
&nbsp;
        for (var i=0; i&lt;attributes.length; i++) {
            ...
            if (attrName === 'marko-body') {
                var parseMode;
&nbsp;
                <span class="missing-if-branch" title="else path not taken" >E</span>if (attr.literalValue) {
                    parseMode = attr.literalValue;
                }
&nbsp;
                <span class="missing-if-branch" title="else path not taken" >E</span>if (parseMode === 'static-text' ||
                    parseMode === 'parsed-text' ||
<span class="branch-2 cbranch-no" title="branch not covered" >                    parseMode === 'html')</span> {
                    return parseMode;
                } else {
<span class="cstat-no" title="statement not covered" >                    this.context.addError({</span>
...
&nbsp;
module.exports = Parser;</pre></td></tr>
</table></pre>
