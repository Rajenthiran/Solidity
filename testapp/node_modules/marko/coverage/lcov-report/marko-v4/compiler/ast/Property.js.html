...
<html lang="en">
<head>
    <title>Code coverage report for marko-v4/compiler/ast/Property.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">marko-v4/compiler/ast/</a> Property.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
        if (key.type === 'Literal') {
            var propName = key.value;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (isValidJavaScriptIdentifier(propName)) {
<span class="cstat-no" title="statement not covered" >                key = propName;</span>
            }
        }
&nbsp;
        return key + ': ' + value;
