...
<html lang="en">
<head>
    <title>Code coverage report for marko-v4/compiler/ast/ObjectExpression.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">marko-v4/compiler/ast/</a> ObjectExpression.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">694×</span>
<span class="cline-any cline-yes">1856×</span>
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!properties || !properties.length) {
...
&nbsp;
module.exports = ObjectExpression;</pre></td></tr>
</table></pre>
