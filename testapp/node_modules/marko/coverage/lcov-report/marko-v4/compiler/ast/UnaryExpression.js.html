...
<html lang="en">
<head>
    <title>Code coverage report for marko-v4/compiler/ast/UnaryExpression.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">marko-v4/compiler/ast/</a> UnaryExpression.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (prefix) {
...
<span class="cstat-no" title="statement not covered" >            writer.write(operator);</span>
        }
    }
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!prefix) {
<span class="cstat-no" title="statement not covered" >            result += operator;</span>
        }
&nbsp;
        return result;
    }
...
&nbsp;
module.exports = UnaryExpression;</pre></td></tr>
</table></pre>
