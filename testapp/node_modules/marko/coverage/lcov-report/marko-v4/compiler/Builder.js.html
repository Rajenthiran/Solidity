...
<html lang="en">
<head>
    <title>Code coverage report for marko-v4/compiler/Builder.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">marko-v4/compiler/</a> Builder.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">87.88% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>261/297</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">33917×</span>
<span class="cline-any cline-yes">2534×</span>
<span class="cline-any cline-yes">31383×</span>
<span class="cline-any cline-yes">30427×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">370×</span>
<span class="cline-any cline-yes">558×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4389×</span>
<span class="cline-any cline-yes">4386×</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4386×</span>
<span class="cline-any cline-yes">5827×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2021×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2021×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1780×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">13544×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">13544×</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">8928×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3763×</span>
<span class="cline-any cline-yes">3763×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3763×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">509×</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">509×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1459×</span>
<span class="cline-any cline-yes">1459×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1650×</span>
<span class="cline-any cline-yes">1650×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1650×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">642×</span>
<span class="cline-any cline-yes">639×</span>
<span class="cline-any cline-yes">1439×</span>
<span class="cline-any cline-yes">1439×</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1439×</span>
...
function makeNode(arg) {
    if (typeof arg === 'string') {
        ...
        return undefined;
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (Array.isArray(arg)) {
        return arg.map((arg) =&gt; {
            return makeNode(arg);
        });
    } else {
<span class="cstat-no" title="statement not covered" >        throw new Error('Argument should be a string or Node or null. Actual: ' + arg);</span>
    }
}
&nbsp;
...
class Builder {
    arrayExpression(elements) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (elements) {
            if (!isArray(elements)) {
                elements = [elements];
            }
&nbsp;
...
&nbsp;
    computedMemberExpression<span class="fstat-no" title="function not covered" >(object, property) {</span>
<span class="cstat-no" title="statement not covered" >        object = makeNode(object);</span>
<span class="cstat-no" title="statement not covered" >        property = makeNode(property);</span>
<span class="cstat-no" title="statement not covered" >        let computed = true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        return new MemberExpression({object, property, computed});</span>
    }
&nbsp;
    concat(args) {
        var prev;
...
&nbsp;
    containerNode<span class="fstat-no" title="function not covered" >(type, generateCode) {</span>
<span class="cstat-no" title="statement not covered" >        if (typeof type === 'function') {</span>
<span class="cstat-no" title="statement not covered" >            generateCode = arguments[0];</span>
<span class="cstat-no" title="statement not covered" >            type = 'ContainerNode';</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        var node = new ContainerNode(type);</span>
<span class="cstat-no" title="statement not covered" >        if (generateCode) {</span>
<span class="cstat-no" title="statement not covered" >            node.setCodeGenerator(generateCode);</span>
        }
<span class="cstat-no" title="statement not covered" >        return node;</span>
    }
&nbsp;
    declaration<span class="fstat-no" title="function not covered" >(declaration) {</span>
<span class="cstat-no" title="statement not covered" >        return new Declaration({declaration});</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            nameVarName = makeNode(nameVarName);</span>
<span class="cstat-no" title="statement not covered" >            valueVarName = makeNode(valueVarName);</span>
<span class="cstat-no" title="statement not covered" >            inExpression = makeNode(inExpression);</span>
<span class="cstat-no" title="statement not covered" >            return new ForEachProp({nameVarName, valueVarName, in: inExpression, body});</span>
        }
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            varName = makeNode(varName);</span>
<span class="cstat-no" title="statement not covered" >            from = makeNode(from);</span>
<span class="cstat-no" title="statement not covered" >            to = makeNode(to);</span>
<span class="cstat-no" title="statement not covered" >            step = makeNode(step);</span>
<span class="cstat-no" title="statement not covered" >            body = makeNode(body);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            return new ForRange({varName, from, to, step, body});</span>
        }
    }
&nbsp;
...
&nbsp;
        if (args) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!isArray(args)) {
<span class="cstat-no" title="statement not covered" >                throw new Error('"args" should be an array');</span>
            }
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!isValidJavaScriptIdentifier(name)) {
<span class="cstat-no" title="statement not covered" >            var error = new Error('Invalid JavaScript identifier: ' + name);</span>
<span class="cstat-no" title="statement not covered" >            error.code = 'INVALID_IDENTIFIER';</span>
...
&nbsp;
    newExpression(callee, args) {
        callee = makeNode(callee);
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (args) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!isArray(args)) {
...
&nbsp;
    node(type, generateCode) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof type === 'function') {
            generateCode = arguments[0];
            type = 'Node';
        }
&nbsp;
        var node = new Node(type);
        <span class="missing-if-branch" title="else path not taken" >E</span>if (generateCode) {
...
&nbsp;
    objectExpression(properties) {
        if (properties) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!isArray(properties)) {
...
&nbsp;
    text(argument, escape, preserveWhitespace) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof argument === 'object' &amp;&amp; !(argument instanceof Node)) {
<span class="cstat-no" title="statement not covered" >            var def = arguments[0];</span>
<span class="cstat-no" title="statement not covered" >            return new Text(def);</span>
        }
        argument = makeNode(argument);
&nbsp;
...
&nbsp;
    variableDeclarator(id, init) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof id === 'string') {
            id = new Identifier({name: id});
        }
        <span class="missing-if-branch" title="else path not taken" >E</span>if (init) {
            init = makeNode(init);
        }
&nbsp;
...
&nbsp;
    vars(declarations, kind) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (declarations) {
            if (Array.isArray(declarations)) {
                for (let i=0; i&lt;declarations.length; i++) {
                    var declaration = declarations[i];
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (!declaration) {
<span class="cstat-no" title="statement not covered" >                        throw new Error('Invalid variable declaration');</span>
                    }
                    if (typeof declaration === 'string') {
                        declarations[i] = new VariableDeclarator({
                            id: new Identifier({name: declaration})
                        });
                    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (declaration instanceof Identifier) {
<span class="cstat-no" title="statement not covered" >                        declarations[i] = new VariableDeclarator({</span>
                            id: declaration
                        });
                    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof declaration === 'object') {
...
&nbsp;
            ...
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof declarations === 'object') {
