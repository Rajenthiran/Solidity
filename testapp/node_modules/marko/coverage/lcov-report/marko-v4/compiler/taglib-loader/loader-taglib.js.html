...
<html lang="en">
<head>
    <title>Code coverage report for marko-v4/compiler/taglib-loader/loader-taglib.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">marko-v4/compiler/taglib-loader/</a> loader-taglib.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">73.73% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>87/118</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
        taglib = this.taglib = taglib || <span class="branch-1 cbranch-no" title="branch not covered" >new Taglib(filePath);</span>
&nbsp;
        propertyHandlers(taglibProps, this, this.dependencyChain.toString());
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!taglib.id) {
            // Fixes #73
            ...
            // different paths.
<span class="cstat-no" title="statement not covered" >            var dirname = nodePath.dirname(filePath);</span>
<span class="cstat-no" title="statement not covered" >            var packageJsonPath = nodePath.join(dirname, 'package.json');</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >            try {</span>
<span class="cstat-no" title="statement not covered" >                var pkg = jsonFileReader.readFileSync(packageJsonPath);</span>
<span class="cstat-no" title="statement not covered" >                taglib.id = pkg.name;</span>
            } catch(e) {}
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!taglib.id) {</span>
<span class="cstat-no" title="statement not covered" >                taglib.id = filePath;</span>
            }
        }
&nbsp;
        return taglib;
...
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!exists(tagFilePath)) {
<span class="cstat-no" title="statement not covered" >                throw new Error('Tag at path "' + tagFilePath + '" does not exist. (' + dependencyChain + ')');</span>
            }
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (name.startsWith('&lt;')) {
            let tagName = name.slice(1, -1);
            this._handleTag(tagName, value, this.dependencyChain.append(name));
        } else <span class="cstat-no" title="statement not covered" >if (name.startsWith('@')) {</span>
<span class="cstat-no" title="statement not covered" >            var attrName = name.substring(1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            var attr = loader.attributeLoader.loadAttribute(</span>
                attrName,
                value,
                this.dependencyChain.append('@' + attrName));
&nbsp;
<span class="cstat-no" title="statement not covered" >            attr.filePath = filePath;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            taglib.addAttribute(attr);</span>
        } else {
<span class="cstat-no" title="statement not covered" >            return false;</span>
        }
    }
&nbsp;
    attributes<span class="fstat-no" title="function not covered" >(value) {</span>
        ...
        //     }
        // }
<span class="cstat-no" title="statement not covered" >        var taglib = this.taglib;</span>
<span class="cstat-no" title="statement not covered" >        var path = this.filePath;</span>
&nbsp;
...
&nbsp;
        for (var tagName in tags) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (tags.hasOwnProperty(tagName)) {
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(dir)) {
<span class="cstat-no" title="statement not covered" >            for (var i = 0; i &lt; dir.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >                scanTagsDir(path, dirname, dir[i], taglib, this.dependencyChain.append(`tags-dir[${i}]`));</span>
            }
        } else {
...
&nbsp;
    taglibImports(imports) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!resolveFrom) {
<span class="cstat-no" title="statement not covered" >            return;</span>
        ...
        var importPath;
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (imports &amp;&amp; Array.isArray(imports)) {
            for (var i=0; i&lt;imports.length; i++) {
                var curImport = imports[i];
                <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof curImport === 'string') {
                    ...
                    if (basename === 'package.json') {
                        ...
                        <span class="missing-if-branch" title="else path not taken" >E</span>if (dependencies) {
...
&nbsp;
                                <span class="missing-if-branch" title="else path not taken" >E</span>if (importPath) {
...
&nbsp;
    textTransformer<span class="fstat-no" title="function not covered" >(value) {</span>
...
<span class="cstat-no" title="statement not covered" >        var taglib = this.taglib;</span>
<span class="cstat-no" title="statement not covered" >        var dirname = this.dirname;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var transformer = new Taglib.Transformer();</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        propertyHandlers(value, {</span>
            path<span class="fstat-no" title="function not covered" >(value) {</span>
<span class="cstat-no" title="statement not covered" >                var path = resolve(value, dirname);</span>
<span class="cstat-no" title="statement not covered" >                transformer.path = path;</span>
            }
&nbsp;
        }, this.dependencyChain.append('textTransformer').toString());
&nbsp;
<span class="cstat-no" title="statement not covered" >        ok(transformer.path, '"path" is required for transformer');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        taglib.addTextTransformer(transformer);</span>
    }
&nbsp;
    /**
...
exports.loadTaglib = function(filePath, taglib, dependencyChain) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!dependencyChain) {
